    ...
    return (
        <div>
            <Box display={'flex'} flexDirection={'row'} justifyContent={'space-around'}>
                ...
                <Button variant="contained" sx={{ height: '60px', width: '60px', position: 'absolute', bottom: '45vh', right: "195px", borderRadius: '30px', backgroundColor: "#FFFFFF", color: "#212146" }} onClick={() => { controlidx((idx + 1) % sizearr) }}><ArrowDownwardIcon /></Button>
                <Button variant="contained" sx={{ height: '60px', width: '60px', position: 'absolute', bottom: '55vh', right: "195px", borderRadius: '30px', backgroundColor: "#FFFFFF", color: "#212146" }} onClick={() => { controlidx(idx - 1 + sizearr) % sizearr }}><ArrowUpwardIcon /></Button>
            </Box >
